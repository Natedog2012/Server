...
void Perl_Mob_SetQuestHide(Mob* self, bool flag)
{
	self->SetQuestHide(flag);
}

void Perl_Mob_RevealTo(Mob* self, Client* client)
{
	self->RevealTo(client);
}

void Perl_Mob_HideFrom(Mob* self, Client* client)
{
	self->HideFrom(client);
}

bool Perl_Mob_PassCastRestriction(Mob* self, int value)
{
	return self->PassCastRestriction(value);
}
...
void perl_register_mob()
{
	...
	package.add("SetQuestHide", &Perl_Mob_SetQuestHide);
	package.add("RevealTo", &Perl_Mob_RevealTo);
	package.add("HideFrom", &Perl_Mob_HideFrom);
	package.add("PassCastRestriction", &Perl_Mob_PassCastRestriction);
	//Custom Natedog END
	...
	package.add("GetActSpellDamage", (int64_t(*)(Mob*, uint16_t, int64_t))&Perl_Mob_GetActSpellDamage);
	package.add("GetActSpellDamage", (int64_t(*)(Mob*, uint16_t, int64_t, Mob*))&Perl_Mob_GetActSpellDamage);
	package.add("GetActSpellDuration", &Perl_Mob_GetActSpellDuration);
	package.add("GetActSpellHealing", (int64_t(*)(Mob*, uint16_t, int64_t))&Perl_Mob_GetActSpellHealing);
	package.add("GetActSpellHealing", (int64_t(*)(Mob*, uint16_t, int64_t, Mob*))&Perl_Mob_GetActSpellHealing);
