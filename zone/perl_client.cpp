...
bool Perl_Client_CheckFizzle(Client* self, int spell_id)
{
	return self->CheckFizzle(spell_id);
}
...
void Perl_Client_SetSpellScaleMod(Client* self, int scale)
{
	self->SetSpellScaleMod(scale);
}

void Perl_Client_SetMeleeScaleMod(Client* self, int scale)
{
	self->SetMeleeScaleMod(scale);
}

void Perl_Client_SetHealScaleMod(Client* self, int scale)
{
	self->SetHealScaleMod(scale);
}

int Perl_Client_GetSPELL_MOD(Client* self)
{
	return self->GetSPELL_MOD();
}

int Perl_Client_GetHEAL_MOD(Client* self)
{
	return self->GetHEAL_MOD();
}
...
void Perl_Client_HandleAugmentation(Client* self, int container)
{
	self->HandleAugmentation(container);
}
...
void perl_register_client()
{
	...
	//Custom Natedog START
	package.add("HandleAugmentation", &Perl_Client_HandleAugmentation);
	package.add("SetSpellScaleMod", &Perl_Client_SetSpellScaleMod);
	package.add("SetMeleeScaleMod", &Perl_Client_SetMeleeScaleMod);
	package.add("SetHealScaleMod", &Perl_Client_SetHealScaleMod);
	package.add("GetSPELL_MOD", &Perl_Client_GetSPELL_MOD);
	package.add("GetHEAL_MOD", &Perl_Client_GetHEAL_MOD);
	package.add("CheckFizzle", &Perl_Client_CheckFizzle);
	//Custom Natedog END
