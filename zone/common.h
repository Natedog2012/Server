...
typedef enum {	//focus types
	...
	focusImprovedDamage3,				//@FC, SPA: 997, SpellEffect::ImprovedDamage3,				On Caster, spell damage mod pct, base: min pct, limit: max pct (Scales after all other damage calcs)
