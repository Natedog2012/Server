...
RULE_INT(Character, Warrior_MeleeCritMod, 0)
RULE_INT(Character, Warrior_SpellDMGMod, 0)
RULE_INT(Character, Warrior_HealAMTMod, 0)
RULE_INT(Character, Warrior_ManaRegenMod, 0)
RULE_INT(Character, Warrior_EndurRegenMod, 0)
RULE_INT(Character, Cleric_MeleeMod, 0)
RULE_INT(Character, Cleric_RegenMod, 0)
RULE_INT(Character, Cleric_DodgeMod, 0)
RULE_INT(Character, Cleric_MeleeCritMod, 0)
RULE_INT(Character, Cleric_SpellDMGMod, 0)
RULE_INT(Character, Cleric_HealAMTMod, 0)
RULE_INT(Character, Cleric_ManaRegenMod, 0)
RULE_INT(Character, Cleric_EndurRegenMod, 0)
RULE_INT(Character, Paladin_MeleeMod, 0)
RULE_INT(Character, Paladin_RegenMod, 0)
RULE_INT(Character, Paladin_DodgeMod, 0)
RULE_INT(Character, Paladin_MeleeCritMod, 0)
RULE_INT(Character, Paladin_SpellDMGMod, 0)
RULE_INT(Character, Paladin_HealAMTMod, 0)
RULE_INT(Character, Paladin_ManaRegenMod, 0)
RULE_INT(Character, Paladin_EndurRegenMod, 0)
RULE_INT(Character, Ranger_MeleeMod, 0)
RULE_INT(Character, Ranger_RegenMod, 0)
RULE_INT(Character, Ranger_DodgeMod, 0)
RULE_INT(Character, Ranger_MeleeCritMod, 0)
RULE_INT(Character, Ranger_SpellDMGMod, 0)
RULE_INT(Character, Ranger_HealAMTMod, 0)
RULE_INT(Character, Ranger_ManaRegenMod, 0)
RULE_INT(Character, Ranger_EndurRegenMod, 0)
RULE_INT(Character, Ranger_ArcheryMod, 0)
RULE_INT(Character, Shadowknight_MeleeMod, 0)
RULE_INT(Character, Shadowknight_RegenMod, 0)
RULE_INT(Character, Shadowknight_DodgeMod, 0)
RULE_INT(Character, Shadowknight_MeleeCritMod, 0)
RULE_INT(Character, Shadowknight_SpellDMGMod, 0)
RULE_INT(Character, Shadowknight_HealAMTMod, 0)
RULE_INT(Character, Shadowknight_ManaRegenMod, 0)
RULE_INT(Character, Shadowknight_EndurRegenMod, 0)
RULE_INT(Character, Druid_MeleeMod, 0)
RULE_INT(Character, Druid_RegenMod, 0)
RULE_INT(Character, Druid_DodgeMod, 0)
RULE_INT(Character, Druid_MeleeCritMod, 0)
RULE_INT(Character, Druid_SpellDMGMod, 0)
RULE_INT(Character, Druid_HealAMTMod, 0)
RULE_INT(Character, Druid_ManaRegenMod, 0)
RULE_INT(Character, Druid_EndurRegenMod, 0)
RULE_INT(Character, Monk_MeleeMod, 0)
RULE_INT(Character, Monk_RegenMod, 0)
RULE_INT(Character, Monk_DodgeMod, 0)
RULE_INT(Character, Monk_MeleeCritMod, 0)
RULE_INT(Character, Monk_SpellDMGMod, 0)
RULE_INT(Character, Monk_HealAMTMod, 0)
RULE_INT(Character, Monk_ManaRegenMod, 0)
RULE_INT(Character, Monk_EndurRegenMod, 0)
RULE_INT(Character, Bard_MeleeMod, 0)
RULE_INT(Character, Bard_RegenMod, 0)
RULE_INT(Character, Bard_DodgeMod, 0)
RULE_INT(Character, Bard_MeleeCritMod, 0)
RULE_INT(Character, Bard_SpellDMGMod, 0)
RULE_INT(Character, Bard_HealAMTMod, 0)
RULE_INT(Character, Bard_ManaRegenMod, 0)
RULE_INT(Character, Bard_EndurRegenMod, 0)
RULE_INT(Character, Rogue_MeleeMod, 0)
RULE_INT(Character, Rogue_RegenMod, 0)
RULE_INT(Character, Rogue_DodgeMod, 0)
RULE_INT(Character, Rogue_MeleeCritMod, 0)
RULE_INT(Character, Rogue_SpellDMGMod, 0)
RULE_INT(Character, Rogue_HealAMTMod, 0)
RULE_INT(Character, Rogue_ManaRegenMod, 0)
RULE_INT(Character, Rogue_EndurRegenMod, 0)
RULE_INT(Character, Shaman_MeleeMod, 0)
RULE_INT(Character, Shaman_RegenMod, 0)
RULE_INT(Character, Shaman_DodgeMod, 0)
RULE_INT(Character, Shaman_MeleeCritMod, 0)
RULE_INT(Character, Shaman_SpellDMGMod, 0)
RULE_INT(Character, Shaman_HealAMTMod, 0)
RULE_INT(Character, Shaman_ManaRegenMod, 0)
RULE_INT(Character, Shaman_EndurRegenMod, 0)
RULE_INT(Character, Necromancer_MeleeMod, 0)
RULE_INT(Character, Necromancer_RegenMod, 0)
RULE_INT(Character, Necromancer_DodgeMod, 0)
RULE_INT(Character, Necromancer_MeleeCritMod, 0)
RULE_INT(Character, Necromancer_SpellDMGMod, 0)
RULE_INT(Character, Necromancer_HealAMTMod, 0)
RULE_INT(Character, Necromancer_ManaRegenMod, 0)
RULE_INT(Character, Necromancer_EndurRegenMod, 0)
RULE_INT(Character, Wizard_MeleeMod, 0)
RULE_INT(Character, Wizard_RegenMod, 0)
RULE_INT(Character, Wizard_DodgeMod, 0)
RULE_INT(Character, Wizard_MeleeCritMod, 0)
RULE_INT(Character, Wizard_SpellDMGMod, 0)
RULE_INT(Character, Wizard_HealAMTMod, 0)
RULE_INT(Character, Wizard_ManaRegenMod, 0)
RULE_INT(Character, Wizard_EndurRegenMod, 0)
RULE_INT(Character, Magician_MeleeMod, 0)
RULE_INT(Character, Magician_RegenMod, 0)
RULE_INT(Character, Magician_DodgeMod, 0)
RULE_INT(Character, Magician_MeleeCritMod, 0)
RULE_INT(Character, Magician_SpellDMGMod, 0)
RULE_INT(Character, Magician_HealAMTMod, 0)
RULE_INT(Character, Magician_ManaRegenMod, 0)
RULE_INT(Character, Magician_EndurRegenMod, 0)
RULE_INT(Character, Enchanter_MeleeMod, 0)
RULE_INT(Character, Enchanter_RegenMod, 0)
RULE_INT(Character, Enchanter_DodgeMod, 0)
RULE_INT(Character, Enchanter_MeleeCritMod, 0)
RULE_INT(Character, Enchanter_SpellDMGMod, 0)
RULE_INT(Character, Enchanter_HealAMTMod, 0)
RULE_INT(Character, Enchanter_ManaRegenMod, 0)
RULE_INT(Character, Enchanter_EndurRegenMod, 0)
RULE_INT(Character, Beastlord_MeleeMod, 0)
RULE_INT(Character, Beastlord_RegenMod, 0)
RULE_INT(Character, Beastlord_DodgeMod, 0)
RULE_INT(Character, Beastlord_MeleeCritMod, 0)
RULE_INT(Character, Beastlord_SpellDMGMod, 0)
RULE_INT(Character, Beastlord_HealAMTMod, 0)
RULE_INT(Character, Beastlord_ManaRegenMod, 0)
RULE_INT(Character, Beastlord_EndurRegenMod, 0)
RULE_INT(Character, Berserker_MeleeMod, 0)
RULE_INT(Character, Berserker_RegenMod, 0)
RULE_INT(Character, Berserker_DodgeMod, 0)
RULE_INT(Character, Berserker_MeleeCritMod, 0)
RULE_INT(Character, Berserker_SpellDMGMod, 0)
RULE_INT(Character, Berserker_HealAMTMod, 0)
RULE_INT(Character, Berserker_ManaRegenMod, 0)
RULE_INT(Character, Berserker_EndurRegenMod, 0)
