...
RULE_INT(Character, Default_Spell_For_BARD_Display, 704, "Healing by default.. change to another spell to display properly for your server")
...
RULE_INT(Character, Shadowknight_CritDMGMod, 0, "")
...
RULE_INT(Character, Necromancer_CritDMGMod, 0, "")
...
RULE_INT(Character, Magician_SpellCritDmgMod, 0, "")
...
RULE_INT(Character, Enchanter_CritDMGMod, 0, "")
...
RULE_INT(Character, Enchanter_SpellCritDmgMod, 0, "")
...
RULE_INT(Character, Beastlord_CritDMGMod, 0, "")
...
RULE_INT(Character, Beastlord_SpellCritDmgMod, 0, "")
...
RULE_INT(Character, Berserker_CritDMGMod, 0, "")
...
RULE_INT(Character, Berserker_SpellCritDmgMod, 0, "")
...
RULE_BOOL(Spells, MoveWhileCasting, false, "Allow players to cast while moving.")
...
RULE_BOOL(Spells, TargetsTargetRequireMeleeRange, true, "ST_TargetsTarget requires melee range by default. False to allow ranged targets")
