...
namespace SpellEffect {
	...
	constexpr int ImprovedDamage3				  = 997; // % scaled magic damage after all other calculations (multiplicative damage)
	constexpr int SmartHealPercent				  = 998; // Custom heal
	constexpr int SmartHeal						  = 999; // Custom heal
}
